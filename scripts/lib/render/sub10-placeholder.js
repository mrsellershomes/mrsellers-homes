...
export function renderSub10Placeholder({ townName, threeMonthBlend }) {
  ...
  <ul class="three-month-blend" aria-label="Single-family activity">
    ...
    <li><span class="blend-label">Sale-to-list ratio</span><span class="blend-value">${blend.saleToList != null ? fmtPct(blend.saleToList) + (blend.saleToList > 1 ? ' (sold over asking)' : blend.saleToList < 1 ? ' (sold under asking)' : ' (sold at asking)') : '—'}</span></li>
  </ul>
</section>`;
}
